...
void QCarshMainDlg::TaskTypeComboChanged(int )
{
...
void QCarshMainDlg::OnFilterApplyPressed()
{
...
void QCarshMainDlg::UpdateTasksList()
{
...
void QCarshMainDlg::OnTasksDblClk(QTableWidgetItem* item)
{
